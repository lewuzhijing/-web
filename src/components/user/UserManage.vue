  ...
  <div>
    <div style="margin-bottom: 5px;">
      <el-input v-model= "name" placeholder="请输入名字" suffix-icon="el-icon-search" style="width:200px"
                @keyup.enter.native="loadPost" v-debounce="loadPost"></el-input>
    ...
    >
      ...
      <el-table-column prop="personAddress" label="个人经历" width="180">
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        ...
        <el-form-item label="个人介绍"  prop="personAddress">
          <el-col :span="20">
            <el-input type="textarea" v-model="form.personAddress"></el-input>
          </el-col>
        </el-form-item>
